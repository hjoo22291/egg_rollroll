...
$(document).ready(function(){
	...
	//부모창 url /구분자로 나눠서 맨 마지막 배열번호 = 마지막요소인 친구id 가져오기
	var friendId = opener.location.href.split('/')[(opener.location.href.split('/').length-1)];
	//alert(id);
	...
	$("#writesubmitbtn").on('click', function(e){
 		...
 		$('#receiver').val(friendId); //receiver = 친구 id로 지정
